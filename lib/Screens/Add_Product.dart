...
import 'package:testproject/Screens/View_Product.dart';
...
class _AddProductState extends State<AddProduct>with Helpers {
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.drive_file_rename_outline, color: Color(0xff5D5D5D),),
              ),
          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                prefixIcon: Icon(Icons.price_check, color: Color(0xff5D5D5D),),
              ),
  ...
  String getScrennTitle() =>  isNewNote() ? 'Create Product' : 'Update Product';
  ...
  bool checkData() {
    ...
    showSnackBar(context, message: 'Enter required Product!', error: true);
    return false;
  }
  ...
  Future<void> _save() async {
    ...
    String message = status ? 'Product saved successfully' : 'Product save failed!';
